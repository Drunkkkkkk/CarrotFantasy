...
Item {
    ...
    property var map: [//7 * 12
        [4,10,10,10,10,10,10, 7, 9,10,10, 7],//0
        [0,20, 0,20, 0, 0,20, 5, 5,20,20, 5],//1
        [9, 10,10,10,10,10,10,1, 5, 0, 0, 5],//2
        [5,20, 0, 0, 0, 0, 0,20, 5, 0, 0, 5],//3
        [5, 0, 0, 4,10,10,10,10, 1, 0, 0, 5],//4
        [5,20, 0, 0,20, 0, 0,20, 0, 0,20, 5],//5
        [3,10,10,10,10,10,10,10,10,10,10, 1]//6
    ]
